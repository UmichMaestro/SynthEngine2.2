...
static void error_callback(RtAudioError::Type type, const std::string &error) {
	...
	void Synth::msmInit() {
		std::string paths[5] = { 
			"C:\\Users\\MDPMaestro2\\Desktop\\w17Changes\\MaestroRun\\maestro_run\\instruments\\BbClar.ff.C4B4-10-440.msm" ,
			"C:\\Users\\MDPMaestro2\\Desktop\\w17Changes\\MaestroRun\\maestro_run\\instruments\\Bassoon.ff.C4B4-10-444.msm",
			...
			"C:\\Users\\MDPMaestro2\\Desktop\\w17Changes\\MaestroRun\\maestro_run\\instruments\\oboe.ff.C4B4-10-439.msm"
		};
	...
	void Synth::soundStart(int index) {
